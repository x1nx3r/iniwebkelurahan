      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="text-center">
          <div className="inline-flex items-center bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-semibold mb-4 sm:mb-6 shadow-lg backdrop-blur-sm border border-green-200/50 transition-all duration-300 hover:scale-105">
            <BuildingStorefrontIcon className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 flex-shrink-0" />
            <span className="whitespace-nowrap">UMKM Kelurahan Kemayoran</span>
          </div>
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold gradient-text mb-4 sm:mb-6 leading-tight px-4">
            <span className="block sm:inline">Produk Lokal</span>
            <span className="block sm:inline"> Unggulan</span>
          </h1>

          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed px-4 mb-6 sm:mb-8">
            Dukung ekonomi lokal dengan berbelanja di UMKM sekitar. Temukan
            produk berkualitas dari tetangga Anda sendiri.
          </p>
        </div>
      </div>
    </section>
